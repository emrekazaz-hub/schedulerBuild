...
const TimelineProvider = props => {
  ...
  /** Prepare data*/
  const pages = useMemo(() => calculateDates(firstDay, minDate, maxDate, initialDate.current), [firstDay, minDate, maxDate]);
  ...
  const heightByTimeInterval = useDerivedValue(() => timeIntervalHeight.value * (60 / timeInterval));
