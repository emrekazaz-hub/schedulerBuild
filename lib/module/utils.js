...
export const calculateDates = (initialFirstDay, minDateStr, maxDateStr, initialDate) => {
  let day = {
      data: [],
      index: -1
    },
...
export const getDayBarStyle = (currentDate, date, theme, highlightDate = {}, dayFS, dayTU, daySO) => {
