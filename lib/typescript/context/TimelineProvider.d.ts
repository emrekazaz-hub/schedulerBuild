...
import type { CalendarViewMode, DayMinutePros, DayMinuteStyleProps, TimelineProviderProps, UnavailableHour } from '../types';
declare type CustomTimelineProviderProps = Required<Omit<TimelineProviderProps, 'initialDate' | 'minTimeIntervalHeight' | 'maxTimeIntervalHeight' | 'unavailableHours' | 'hourFormat' | 'timeZone' | 'calendarWidth' | 'nightHours' | 'dayMinutes' | 'dayMinuteStyle'>>;
