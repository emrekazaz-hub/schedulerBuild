...
export interface TimelineCalendarProps extends TimelineProps, TimelineProviderProps {
}
...
export declare type CalendarViewMode = 'day' | 'week' | 'threeDays' | 'fiveDays' | 'workWeek';
...
export declare type UnavailableHoursStyle = Record<string, {
    top: number;
    height: number;
}[]>;
...
export declare type HighlightDates = {
    [date: string]: {
